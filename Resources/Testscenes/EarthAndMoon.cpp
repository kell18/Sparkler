...
int main() 
{
	...
	s1.shininess = 100.f;
	s1.reflectRate = 0.f;
	Material s2 = { emission+0.03f, emission+0.99f, emission+0.1f, emission };
	s2.shininess = 1.f;
	s2.reflectRate = 0.f;
	Material s3 = { emission+0.03f, emission+0.7f, emission+0.05f, emission };
	s3.shininess = 50.f;
	s3.reflectRate = 0.f;
	...
	r1->loadTexture("C:\\Dropbox\\Code\\Cpp\\Raytracer\\Resources\\Imgs\\Stuff\\stars8.jpg");
	...
	vector<Light*> l;
	l.push_back(new Light(vec3(4.f, -3.f, 5.5f), white, 1.5f, LightType::Point));
